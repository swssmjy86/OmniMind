...
export const metadata: Metadata = {
  ...
  description: "사주 계산의 정확성, 무료 범위, 개인정보까지 — 자주 받는 질문에 답해요.",
};
...
export const FAQ_ITEMS: { q: string; a: string; link?: { href: string; label: string } }[] = [
  ...
  {
    q: "태어난 시간을 몰라도 되나요?",
    a: "오늘의운세는 태어난 시간까지 입력해야 정확한 하루 기운을 볼 수 있어요. 총운·직업운·연애운 같은 심층 풀이는 시간을 몰라도 년·월·일 세 기둥만으로 풀어드려요.",
  },
  {
    q: "무료는 어디까지인가요?",
    a: "전부 무료예요. 오늘의운세부터 총운·직업운·연애운·재물운·궁합·결혼운 같은 심층 풀이, 마음·고민 상담까지 모두 로그인 없이 이 기기에서 바로 쓸 수 있어요.",
  },
  {
    q: "회원가입이나 결제가 필요한가요?",
    a: "아니요, 둘 다 필요 없어요. 계정도 결제도 없이 모든 기능이 무료예요. 입력한 생년월일·기록은 서버가 아니라 이 기기(브라우저)에만 저장돼요.",
  },
  {
    q: "AI가 보는 건가요?",
