...
export const metadata: Metadata = {
  ...
  description: "사주 계산의 정확성, 무료 범위, 결제 여부, 개인정보까지 — 자주 받는 질문에 답해요.",
};
...
export const FAQ_ITEMS: { q: string; a: string; link?: { href: string; label: string } }[] = [
  ...
  {
    q: "무료는 어디까지인가요?",
    a: "오늘의운세는 로그인 없이도 누구나 무료예요. 로그인하면 총운·직업운·연애운·재물운·궁합·결혼운 같은 심층 풀이와 마음·고민 상담까지, 지금은 모두 무료로 만날 수 있어요.",
  },
  {
    q: "결제나 구독이 필요한가요?",
    a: "아니요, 지금은 필요 없어요. 로그인만 하면 크레딧 소비 없이 모든 풀이를 볼 수 있어요.",
  },
  {
    q: "AI가 보는 건가요?",
